...
const SKILL_NODES: SkillNode[] = [
  ...
  },
  {
    ...
    y: 35,
    type: "frontend",
    description: "ใช้ในการจัดการ State, Logic ฝั่งไคลเอนต์ การตอบสนอง of UI แบบไดนามิก และการเขียนอนิเมชันร่วมกับเฟรมเวิร์กยอดนิยมเช่น React",
  ...
  },
  {
    ...
    y: 52,
    type: "automation",
    description: "ใช้ในการเขียนสคริปต์สําหรับงาน Automation, ประมวลผลข้อมูล และเชื่อมต่อกับโมเดล AI (เช่น Gemini API) เพื่อพัฒนาระบบอัจฉริยะแบบไร้รอยต่อ",
    connections: ["c_lang"]
  }
];
